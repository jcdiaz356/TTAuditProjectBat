...
public class PollPublicityActivity extends AppCompatActivity {
    ...
    private TextView tvStoreFullName,tvStoreId,tvAddress ,tvReferencia,tvDistrict,tvAuditoria,tvPoll,tvOwner,tvPublicity ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvPublicity.setText(String.valueOf(publicity.getFullname() + "(" + publicity.getId() + ")"));
...
//        int intChecked = isChecked ? 1 : 0;
    ...
    /**
     * Muestra el tipo de teclado que se activará para el control
     * @param typeKeyBoard
     * @param control
     */
    private void inputTypeEntreKeyBoard(int typeKeyBoard,EditText control){
        switch (typeKeyBoard){
            case 0:
                control.setInputType(InputType.TYPE_TEXT_FLAG_CAP_WORDS );
                break;
            case 1:
                control.setInputType(InputType.TYPE_CLASS_NUMBER | InputType.TYPE_NUMBER_FLAG_SIGNED );
                break;
            case 2:
                control.setInputType(InputType.TYPE_CLASS_NUMBER | InputType.TYPE_NUMBER_FLAG_DECIMAL );
                break;
        }
    }
