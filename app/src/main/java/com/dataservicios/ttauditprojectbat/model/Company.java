...
public class Company {
    ...
    @DatabaseField
    private int    max_photo_notification;
    @DatabaseField
    ...
    public int getMax_photo_notification() {
        return max_photo_notification;
    }

    public void setMax_photo_notification(int max_photo_notification) {
        this.max_photo_notification = max_photo_notification;
    }
